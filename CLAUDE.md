...
This command **requires** the project directory as an argument via `D:\repos\home-designer`.

**Example:** `/create-spec generations/my-app`

**Output location:** `D:\repos\home-designer/.autoforge/prompts/app_spec.txt` and `D:\repos\home-designer/.autoforge/prompts/initializer_prompt.md`

If `D:\repos\home-designer` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `D:\repos\home-designer/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `D:\repos\home-designer/.autoforge/prompts/app_spec.txt`
...
**Output path:** `D:\repos\home-designer/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `D:\repos\home-designer/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `D:\repos\home-designer/.autoforge/prompts/`!
>
> **Files created:**
> - `D:\repos\home-designer/.autoforge/prompts/app_spec.txt`
> - `D:\repos\home-designer/.autoforge/prompts/initializer_prompt.md`
>
